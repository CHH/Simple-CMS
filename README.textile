...
# Setup a new VHOST and point its document root to the public directory of the Simple CMS install, for example @/var/www/simple_cms/public@
# Start your server and open the URL of your VHOST in a Browser -- you should see the Getting Started Page

Don't forget to update your @/etc/hosts@ or @C:\Windows\system32\drivers\etc\hosts@ file with the server name of your VHOST!
